...
try:
    ...
    from ParkingEnv import ParkingEnv  # when running from within src/

# config do treinamento
LOG_DIR = "logs" # diretório para logs do TensorBoard
MODEL_SAVE_DIR = "models" # diretório para salvar os modelos
MODEL_NAME = "SAC_Improved_V3" # nome do modelo para carregar/treinar/salvar (V2 with improved obs/rewards)
