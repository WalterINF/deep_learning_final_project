...
class TestMapGeneration(unittest.TestCase):
    ...
    def test_map_generation(self):
        ...
        rgb_array_1 = to_rgb_array(simulation_1, img_size=(1024, 1024))
        simulation_2 = simulation_loader.load_simulation()
        rgb_array_2 = to_rgb_array(simulation_2, img_size=(1024, 1024))
        simulation_3 = simulation_loader.load_simulation()
        rgb_array_3 = to_rgb_array(simulation_3, img_size=(1024, 1024))
        #subplots
