...
class ParkingEnv(gym.Env):
    ...
    JACKKNIFE_LIMIT_RAD = float(np.deg2rad(45.0)) # angulo maximo de jackknife
    DT = 1 # tempo do passo de simulação
    MAX_SECONDS = 90.0
    MAX_STEPS = int(MAX_SECONDS / DT)
    VEHICLE_PARKED_THRESHOLD_M = 1.0 # distancia minima entre centro do trailer e centro da vaga para considerar o veículo estacionado
    ...
    PUNISHMENT_COLLISION = -100.0 # penalidade por colisão com paredes
