...
from dominio.data_class_loader.dc_loader_parametros_veiculo import ParametrosGeometricosVeiculo
from dominio.entidades.estados import Estado5, Estado3
from interfaces.i_paramatros_veiculo import IParametrosVeiculo
## Single-Trailer

class ParametrosTratorTrailer(IParametrosVeiculo):
...
class ParametrosTrator(IParametrosVeiculo):
    """ Parâmetros geométricos do conjunto trator + trailer.
    ---------------------------------- TRATOR ----------------------------------
    :param comprimento_trator:                [m] comprimento total do trator.
    :param distancia_eixo_traseiro_quinta_roda: [m] distância entre o eixo traseiro do trator e a quinta roda.
