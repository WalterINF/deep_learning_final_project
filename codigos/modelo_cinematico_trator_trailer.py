...
from dominio.calculos_com_angulos import Angulos
from interfaces.i_modelo import IModelo
from dominio.entidades.estados import Estado7, Estado4, Estado5, Estado3

class TratorComUmTrailer(IModelo):
